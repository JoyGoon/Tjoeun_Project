...
public class CeoList {
	...
	private ArrayList<CeoVO> list = new ArrayList<>();
	...
	public CeoList() { }
	public CeoList(int pageSize, int totalCount, int currentPage) {
	...
	public ArrayList<CeoVO> getList() {
		return list;
	}
	public void setList(ArrayList<CeoVO> list) {
		this.list = list;
	}
