...
<%@page import="com.tjoeun.vo.LoginVO"%>
...
<!-- vo 변수 생성 -->
<jsp:useBean id="vo" class="com.tjoeun.vo.LoginVO">
...
<%
	...
	// 입력받은 아이디로 DB에서 같은 아이디 찾기

	vo = SelectService.getInstance().selectbyCnum(inserted_cnum);
	...
	// DB에서 불러온 데이터 없을 경우
	else if ( inserted_cnum != '\0' && inserted_password != null && vo == null && !flag ) {
		out.println("<script>");
	...
	else if ( !vo.getPassword().equals(inserted_password) && !flag ) {
		out.println("<script>");
